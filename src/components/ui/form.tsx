...
function FormLabel({ className, ...props }: React.ComponentProps<typeof LabelPrimitive.Root>) {
  ...
  return <LabelPrimitive.Root className={cn("text-sm font-medium", error && "text-danger", className)} htmlFor={formItemId} {...props} />;
}
...
function FormMessage({ className, children, ...props }: React.ComponentProps<"p">) {
  ...
  if (!body) return null;
  return <p id={formMessageId} className={cn("text-sm font-medium text-danger", className)} {...props}>{body}</p>;
}
